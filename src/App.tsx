...
> = {
  "comunicado-venda": {
    ...
    fields: [
      ...
      { name: "Dia_Venda", label: "Dia da Venda" },
      { name: "Mes_Venda", label: "Mês da Venda" },
      { name: "Ano_Venda", label: "Ano da Venda" },
      { name: "Cidade", label: "Cidade" },
      { name: "Dia_Doc", label: "Dia do Documento" },
      { name: "Mes_Doc", label: "Mês do Documento" },
      { name: "Ano_Doc", label: "Ano do Documento" },
    ],
  },
  "cancelamento-intencao-venda": {
